...
const greeting = {
  ...
  nickname: "mononoke",
  subTitle:
    "A passionate individual who always thrives to work on end to end products which develop sustainable and scalable social and technical systems to create impact.Freshmen graduate student at NC State specializing in Software Engineering",
  resumeLink:
